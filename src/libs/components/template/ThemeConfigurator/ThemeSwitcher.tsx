...
const ColorBadge = ({
    ...
    const { primaryColorLevel } = useTheme();
...
const ThemeSwitcher = () => {
    const { themeColor, primaryColorLevel, ThemeActions } = useTheme();

    const onThemeColorChange = ({ value }: ColorList) => {
        ThemeActions.setThemeColor(value);
    };

    const onThemeColorLevelChange = ({ value }: ColorLevelList) => {
        ThemeActions.setThemeColorLevel(value);
    };
