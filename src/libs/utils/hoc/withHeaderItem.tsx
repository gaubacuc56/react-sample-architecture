        ...
        return (
            <Component
                ...
                className={classNames(
                    ...
                    hoverable && 'hover:bg-black hover:bg-opacity-5 hover:text-gray-900 dark:hover:bg-blackdark:hover:text-gray-100dark:hover:bg-opacity-40transition-colors duration-300 ease-in-out',
                    className
                )}
            />
        )
